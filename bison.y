...
block : type_definition_part variable_declaration_part procedure_declaration_part statement_part
;
...
procedure_declaration_part : procedure_declaration | empty
;
...
simple_statement : assignment_statement| procedure_statement | empty
                 ;
